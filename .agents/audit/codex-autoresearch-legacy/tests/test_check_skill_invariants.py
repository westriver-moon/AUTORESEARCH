...
class CheckSkillInvariantsTest(unittest.TestCase):
    ...
    def test_openai_manifest_requires_explicit_invocation(self) -> None:
    ...
    def test_exec_invariants_reject_event_logs_without_bundled_helper_usage(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            event_log.write_text(
                'command: python scripts/autoresearch_init_run.py\n',
                encoding="utf-8",
            )
    ...
    def test_exec_invariants_accept_bundled_helper_usage_in_event_log(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            event_log.write_text(
                "\n".join(
                    [
                        'command: python .agents/skills/codex-autoresearch/scripts/autoresearch_init_run.py --mode exec',
                        'command: python .agents/skills/codex-autoresearch/scripts/autoresearch_record_iteration.py --status keep',
                        'command: python .agents/skills/codex-autoresearch/scripts/autoresearch_exec_state.py --cleanup',
                    ]
                )
                + "\n",
                encoding="utf-8",
    ...
    def test_exec_invariants_accept_admin_scope_skill_paths(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            event_log.write_text(
                "\n".join(
                    [
                        "command: python /etc/codex/skills/codex-autoresearch/scripts/autoresearch_init_run.py --mode exec",
                        "command: python /etc/codex/skills/codex-autoresearch/scripts/autoresearch_record_iteration.py --status keep",
                        "command: python /etc/codex/skills/codex-autoresearch/scripts/autoresearch_exec_state.py --cleanup",
                    ]
                )
                + "\n",
                encoding="utf-8",
    ...
    def test_exec_invariants_accept_user_scope_skill_paths(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            event_log.write_text(
                "\n".join(
                    [
                        "command: python /Users/alice/.agents/skills/codex-autoresearch/scripts/autoresearch_init_run.py --mode exec",
                        "command: python /Users/alice/.agents/skills/codex-autoresearch/scripts/autoresearch_record_iteration.py --status keep",
                        "command: python /Users/alice/.agents/skills/codex-autoresearch/scripts/autoresearch_exec_state.py --cleanup",
                    ]
                )
                + "\n",
                encoding="utf-8",
    ...
    def test_exec_invariants_accept_absolute_configured_skill_paths(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            event_log.write_text(
                "\n".join(
                    [
                        "command: python /opt/skills/codex-autoresearch/scripts/autoresearch_init_run.py --mode exec",
                        "command: python /opt/skills/codex-autoresearch/scripts/autoresearch_record_iteration.py --status keep",
                        "command: python /opt/skills/codex-autoresearch/scripts/autoresearch_exec_state.py --cleanup",
                    ]
                )
                + "\n",
                encoding="utf-8",

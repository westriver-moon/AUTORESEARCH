...
Ship mode follows the same interactive launch contract as the other iterating
modes. Before `go`, confirm these generic fields and run in foreground only.
Do not hand off through a launch manifest or detached runtime.
